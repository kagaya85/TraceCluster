...
model_path = 'E:\Data\TraceCluster\log\\2-week-test\\final_test\modify_edge\paper-model\\20epoch_CGConv_mean_2layers_32batch_view_random_0301data_select_normal\\'
...
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.025, kernel='rbf')
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.003, kernel='rbf')
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.035, kernel='rbf')
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.04, kernel='rbf')
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.045, kernel='rbf')
...
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.005, kernel='rbf')
...
# oc_svm_classify(emb_train, emb_test, y_train, y_test, nu=0.02, kernel='rbf')
...
# plt.scatter(x[:, 0], x[:, 1], c=url_class_list, marker='o', s=10, cmap=plt.cm.Spectral)
# plt.show()
