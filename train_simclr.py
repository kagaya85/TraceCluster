...
def main():
    ...
    for batch in batches:
        ...
        dataset = TraceDataset(root='G:\Data\TraceCluster\\0301-data\\final_train_normal_big_data', aug=aug)
        ...
        # Set up logging
        output_path = f"E:\Data\TraceCluster\log\\2-week-test\\final_test\\" + time.strftime("%Y-%m-%d_%Hh-%Mm-%Ss", time.localtime()) \
                      + '{}epoch_{}_{}_{}layers_{}batch_{}'.format(epochs, gnn_type, pooling_type, num_layers, batch_size, aug) + '_0301data_select_normal'
