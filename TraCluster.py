...
from TraceClusterDataset import TraceClusterDataset
...
if __name__ == '__main__':
    ...
    dataset = TraceClusterDataset(path, aug=args.aug).shuffle()
    ...
    for epoch in range(1, epochs+1):
        ...
        for data in tqdm(dataloader):
            ...
            x = model(data.x, data.edge_index, data.batch, data.num_graphs)    # ????? num_graphs 怎么整
        ...
        torch.save(model.state_dict(), args.weights + 'model_weights_epoch{}.pth'.format(epoch))
    ...
    with open('logs/log_' + args.DS + '_' + args.aug, 'a+') as f:
        ...
        f.write('Dataset: {},tpe: {},Num_layers: {},Epochs: {},Log_interval: {},Learning rate: {},Acc: {}\n'.format(args.DS, tpe, args.num_gc_layers, epochs, log_interval, lr, s))
        f.write('\n')
