...
data_path_list = [
    '/home/kagaya/work/cluster/data/raw/F01-02/ERROR_F012_SpanData2021-08-14_01-52-43.csv',
    '/home/kagaya/work/cluster/data/raw/F02-04/ERROR_SpanData.csv',
    '/home/kagaya/work/cluster/data/raw/F03-01/ERROR_SpanData.csv',
    #'/home/kagaya/work/cluster/data/raw/F04-01/ERROR_SpanData.csv',
    #'/home/kagaya/work/cluster/data/raw/F05-01/ERROR_SpanData.csv',
    #'/home/kagaya/work/cluster/data/raw/F07-01/ERROR_errorf0701_SpanData2021-08-10_14-09-59.csv'
    # '/home/kagaya/work/cluster/data/raw/normal/normal0823/SUCCESS2_SpanData2021-08-23_15-15-08.csv'
]

time_now_str = str(time.strftime("%Y-%m-%d_%H-%M-%S", time.localtime()))

embedding_word_list = np.load('/home/kagaya/work/cluster/data/glove/wordsList.npy').tolist()
embedding_word_vector = np.load('/home/kagaya/work/cluster/data/glove/wordVectors.npy')
