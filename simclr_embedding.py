...
def main():
    ...
    eval_dataset = TraceDataset(root='E:\Data\TraceCluster\\0301-data\\abnormal_mem', aug='none')
    dataset = TraceDataset(root='E:\Data\TraceCluster\\0301-data\\normal_mem', aug='none')
    ...
    eval_normal_dataset = Subset(dataset, test_idx)
    train_normal_dataset = Subset(dataset, train_idx)
    train_dataloader = DataLoader(train_normal_dataset, batch_size=batch_size, shuffle=True, num_workers=10)
    eval_dataloader = DataLoader(eval_normal_dataset, batch_size=batch_size, shuffle=True, num_workers=10)
    eval_ab1_dataloader = DataLoader(eval_dataset, batch_size=batch_size, shuffle=True)
    ...
    emb_normal_test, y_normal_test, trace_class_test, url_status_class_test, url_class_list_test = model.encoder.get_embeddings(eval_dataloader)
