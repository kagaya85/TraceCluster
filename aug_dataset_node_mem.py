    ...
    def _get_node_features(self, trace, operation_embedding, num_features_stat, api_pair_map):
        ...
        for span_id, attr in trace["vertexs"].items():
            ...
            for feature in self.kpi_features:
                ...
                # feature_num = self._z_score(attr[feature], num_features_stat[attr['operation']][feature])
                # feat.append(feature_num)
                # feat_stat.append(num_features_stat[attr['operation']][feature][0])
                # feat_stat.append(num_features_stat[attr['operation']][feature][1])
...
if __name__ == '__main__':
    print("start...")
    dataset = TraceDataset(root="E:\Data\TraceCluster\\0218_node_data\\test_data_mem")
