...
with open('E:\Data\TraceCluster\\0301-data\\all_mem\preprocessed\\0.json', 'r') as f:
    dic = json.load(f)

type1 = 'POST:/api/v1/orderservice/order/refresh03'
type1_num = 1000
type1_ab = 'POST:/api/v1/orderservice/order/refresh12'
type1_ab_num = 50
...
#             id_classes_list.append(root_url)
#             count_list[indx] += 1
